...
const Form = ({ currentId, setCurrentId }) => {
  ...
  const post = useSelector((state) => currentId ? state.posts.find((obj) => obj._id === currentId) : null);
     ...
     return(
       <Paper className={classes.paper}>
         <Typography variant="h6" align="center">
           Please Sign In to create your own memories and like the others memories.
         </Typography>
       </Paper>
     )
  }
